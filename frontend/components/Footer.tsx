...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark-surface border-t border-neon-cyan/10 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <h3 className="text-2xl font-bold mb-2">
              ...
              <span className="text-text-primary">udhakar</span>
            </h3>
            ...
            <div className="space-y-2">
              {[
                ...
                <a
                  key={link.label}
                  href={link.href}
                  className="block text-text-secondary text-sm hover:text-neon-cyan transition-colors"
                >
                  {link.label}
                </a>
              ))}
        ...
        {/* Divider */}
        <motion.div
          className="border-t border-neon-cyan/10 pt-8"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-text-muted text-sm text-center md:text-left">
              © {currentYear} Sudhakar Bollam. All rights reserved.
            </p>
            <p className="text-text-muted text-sm text-center">
              Crafted with <span className="text-neon-pink">❤️</span> using Next.js, Tailwind CSS &
              Framer Motion
            </p>
          </div>
        </motion.div>
